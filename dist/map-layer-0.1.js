...
*/
    ...
    k.Ff = function (a, b) {
        ...
        var f = c.padding ? c.padding : [0,0,0,0], g = void 0 !== c.constrainResolution ? c.constrainResolution : !0, h = void 0 !== c.nearest ? c.nearest : !1, l;
    ...
    function Cg(a) {
        var b = a.c, c = a.f, b = [b,[b[0],c[1]],c,[c[0],b[1]]].map(a.b.Za, a.b);
        b[4] = b[0].slice();
    ...
    Mg.prototype.j = function () {
        ...
        if (this.G) {
            var e = b.ed(c), d = [a.Ka(bb(d)),a.Ka(db(d))], a = Va(Infinity, Infinity, -Infinity, -Infinity, void 0), f, g;
            f = 0;
    ...
    u(hh, yb);
    var kh = 6378137 * Math.PI, ih = [-kh,-kh,kh,kh], jh = [-180,-85,180,85], Lb = 'EPSG:3857 EPSG:102100 EPSG:102113 EPSG:900913 urn:ogc:def:crs:EPSG:6.18:3:3857 urn:ogc:def:crs:EPSG::3857 http://www.opengis.net/gml/srs/epsg.xml#3857'.split(' ').map(function (a) {
            return new hh(a);
        });
    function Mb(a, b, c) {
        var d = a.length;
    ...
    (function () {
        ...
        (function (c) {
            ...
            return function d(a, b, g) {
                ...
                1: [function(a,b){function d(a,b,f,g,q){f=f||0;g=g||a.length-1;for(q=q||h;g>f;){if(600<g-f){var l=g-f+1,m=b-f+1,p=Math.log(l),n=.5*Math.exp(2*p/3),p=.5*Math.sqrt(p*n*(l-n)/l)*(0>m-l/2?-1:1);d(a,b,Math.max(f,Math.floor(b-m*n/l+p)),Math.min(g,Math.floor(b+(l-m)*n/l+p)),q)}l=a[b];m=f;n=g;e(a,f,b);for(0<q(a[g],l)&&e(a,f,g);m<n;){e(a,m,n);m++;for(n--;0>q(a[m],l);)m++;
                for(;0<q(a[n],l);)n--}0===q(a[f],l)?e(a,f,n):(n++,e(a,n,g));n<=b&&(f=n+1);b<=n&&(g=n-1)}}function e(a,b,d){var e=a[b];a[b]=a[d];a[d]=e}function h(a,b){return a<b?-1:a>b?1:0}b.ma=d},{}],
                2: [function(a,b){function d(a,b){if(!(this instanceof d))return new d(a,b);this.wf=Math.max(4,a||9);this.Pg=Math.max(2,Math.ceil(.4*this.wf));b&&this.Lj(b);this.clear()}function e(a,b){h(a,0,a.children.length,b,a)}function h(a,b,d,e,f){f||(f=x(null));f.da=Infinity;f.fa=Infinity;f.ba=-Infinity;f.ja=-Infinity;for(var g;b<
                ...
                if (e = Wj(b, c)) {
                    ...
                    do {
                        ...
                        if (h.length) {
                            ...
                            Rj(h, f.W, l, m);
                            f.W = h;
                            Fj(c, [Math.min(f.aa.x,h.x),Math.min(f.aa.y,h.y),Math.max(f.aa.x,h.x),
    ...
    function Yj(a, b, c, d) {
        ...
        do {
            ...
            if (l) {
                ...
                c.remove(n);
                m = n === e;
                d ? (l[0] === f.aa.x && l[1] === f.aa.y ? (xj(b), l = f.aa, g.aa = l, c.remove(f), m = m || f === e) : (l = g.W, f.W = l, c.remove(g), m = m || g === e), tj(b)) : (l = Qj(a, l[0], l[1], p), f.W = l, g.aa = l, Fj(c, [Math.min(f.aa.x,f.W.x),Math.min(f.aa.y,f.W.y),Math.max(f.aa.x,f.W.x),Math.max(f.aa.y,f.W.y)], f), Fj(c, [Math.min(g.aa.x,g.W.x),Math.min(g.aa.y,g.W.y),Math.max(g.aa.x,g.W.x),Math.max(g.aa.y,
                g.W.y)], g));
                a.b[h++] = n.aa.gb;
                a.b[h++] = n.W.gb;
                a.b[h++] = l.gb;
    ...
    function Vj(a, b, c, d, e) {
        var f, g, h, l = [], m = Hj(d, [Math.min(a.x,b.x,c.x),Math.min(a.y,b.y,c.y),Math.max(a.x,b.x,c.x),Math.max(a.y,b.y,c.y)]);
        d = 0;
    ...
    k.vl = function () {
        ...
        if (this.get(uk) && this.autoPan) {
            var a = this.Ge();
            if (a && a.Kc()) {
                var b = xk(a.Kc(), a.Mb()), c = this.se(), d = c.offsetWidth, e = c.currentStyle || getComputedStyle(c), d = d + (parseInt(e.marginLeft, 10) + parseInt(e.marginRight, 10)), e = c.offsetHeight, f = c.currentStyle || getComputedStyle(c), e = e + (parseInt(f.marginTop, 10) + parseInt(f.marginBottom, 10)), g = xk(c, [d,e]), c = this.j;
    ...
    function dl() {
        if (!cl) {
            ...
            cl = [new $k({image:new Yk({fill:a,stroke:b,radius:5}),fill:a,stroke:b})];
        }
        return cl;
    }
    function el() {
        ...
        a.LineString = [new $k({stroke:new rj({color:b,width:5})}),new $k({stroke:new rj({color:c,width:3})})];
        a.MultiLineString = a.LineString;
        a.Circle = a.Polygon.concat(a.LineString);
        a.Point = [new $k({image:new Yk({radius:6,fill:new Zk({color:c}),stroke:new rj({color:b,width:1.5})}),zIndex:Infinity})];
    ...
    var un = ["text","type"], tn = K($m, {
            ...
            type: J(Mm),
            rtept: tl(J(vn))
        }), wn = K($m, ["ele","time"]), Bn = K($m, 'name cmt desc src link number type trkseg'.split(' ')), En = K($m, {
            name: J(Mm),
            cmt: J(Mm),
            desc: J(Mm),
            src: J(Mm),
    ...
    function Tn(a) {
        a = a ? a : {};
        zm.call(this);
        Un || (Vn = [255,255,255,1], Wn = new Zk({ color: Vn }), Xn = [20,2], Yn = Zn = 'pixels', $n = [64,64], ao = 'https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png', bo = 0.5, co = new Rn({
            anchor: Xn,
    ...
    u(Tn, zm);
    var jo = ["http://www.google.com/kml/ext/2.2"], ko = [null,"http://earth.google.com/kml/2.0","http://earth.google.com/kml/2.1","http://earth.google.com/kml/2.2","http://www.opengis.net/kml/2.2"], lo = {
            fraction: 'fraction',
            pixels: 'pixels'
        };
    function mo(a, b) {
    ...
    function ip(a, b) {
        var c = Qc(b), c = [255*(4==c.length?c[3]:1),c[2],c[1],c[0]], d;
        for (d = 0; 4 > d; ++d) {
    ...
    var Ep = K(ko, ["Document","Placemark"]), Hp = K(ko, {
        ...
        }, Kp = K(ko, ["href"], K(jo, ["x","y","w","h"])), Lp = K(ko, { href: J(Mm) }, K(jo, {
            x: J(Nm),
            y: J(Nm),
            w: J(Nm),
            h: J(Nm)
        })), Mp = K(ko, ["scale","heading","Icon","hotSpot"]), Op = K(ko, {
            ...
            scale: J(Dp)
        }), Pp = K(ko, ["color","scale"]), Qp = K(ko, {
            color: J(ip),
            scale: J(Dp)
        }), Rp = K(ko, ["color","width"]), Sp = K(ko, {
            color: J(ip),
            width: J(Nm)
        ...
        }), Wp = K(ko, { color: J(ip) }), Up = K(ko, ["IconStyle","LabelStyle","LineStyle","PolyStyle"]), Vp = K(ko, {
    ...
    (function () {
        ...
        (function (c) {
            ...
            return function d(a, b, g) {
                ...
                1: [function(a,b,f){f.read=function(a,b,d,e,f){var g;g=8*f-e-1;var h=(1<<g)-1,l=h>>1,m=-7;f=d?f-1:0;var p=d?-1:1,y=a[b+f];f+=p;d=y&(1<<-m)-1;y>>=-m;for(m+=g;0<m;d=256*d+a[b+f],f+=p,m-=8);g=d&(1<<-m)-1;d>>=-m;for(m+=e;0<m;g=256*g+a[b+f],f+=p,m-=8);if(0===d)d=1-l;else{if(d===h)return g?NaN:Infinity*(y?-1:1);g+=Math.pow(2,e);d-=l}return(y?-1:1)*g*Math.pow(2,d-
                ...
                n]=e&255,n+=z,e/=256,h-=8);a[d+n-z]|=128*A}},{}],
                2: [function(a,b){function d(a){this.lc=ArrayBuffer.isView&&ArrayBuffer.isView(a)?a:new Uint8Array(a||0);this.type=this.ga=0;this.length=this.lc.length}function e(a,b,d){var e=d.lc,f,g;g=e[d.ga++];f=(g&112)>>4;if(128>g)return h(a,f,b);g=e[d.ga++];f|=(g&127)<<3;if(128>g)return h(a,f,b);g=e[d.ga++];f|=(g&127)<<10;if(128>g)return h(a,f,b);g=e[d.ga++];f|=(g&127)<<17;if(128>g)return h(a,f,b);g=e[d.ga++];f|=(g&127)<<24;if(128>g)return h(a,f,b);g=e[d.ga++];
                ...
                55296),g=56320|g&1023);d+=String.fromCharCode(g);e+=h}this.ga=a;return d},zp:function(a){a&=7;if(a===d.c)for(;127<this.lc[this.ga++];);else if(a===d.b)this.ga=this.Ma()+this.ga;else if(a===d.a)this.ga+=4;else if(a===d.f)this.ga+=8;else throw Error("Unimplemented type: "+a);}}},{ieee754:1}]
            }, {}, [2])(2);
        }));
        Bj = b.ma;
    }());
    (function () {
        ...
        (function (c) {
            ...
            return function d(a, b, g) {
                ...
                1: [function(a,b){function d(a,b){this.x=a;this.y=b}b.ma=d;d.prototype={clone:function(){return new d(this.x,this.y)},add:function(a){return this.clone().Ej(a)},rotate:function(a){return this.clone().Oj(a)},round:function(){return this.clone().Pj()},angle:function(){return Math.atan2(this.y,this.x)},Ej:function(a){this.x+=a.x;this.y+=a.y;return this},Oj:function(a){var b=
                Math.cos(a);a=Math.sin(a);var d=a*this.x+b*this.y;this.x=b*this.x-a*this.y;this.y=d;return this},Pj:function(){this.x=Math.round(this.x);this.y=Math.round(this.y);return this}};d.b=function(a){return a instanceof d?a:Array.isArray(a)?new d(a[0],a[1]):a}},{}],
                2: [function(a,b){b.ma.Dj=a("./lib/vectortile.js");b.ma.Yp=a("./lib/vectortilefeature.js");b.ma.Zp=a("./lib/vectortilelayer.js")},{"./lib/vectortile.js":3,"./lib/vectortilefeature.js":4,"./lib/vectortilelayer.js":5}],
                3: [function(a,b){function d(a,
                b,d){3===a&&(a=new e(d,d.Ma()+d.ga),a.length&&(b[a.name]=a))}var e=a("./vectortilelayer");b.ma=function(a,b){this.layers=a.mg(d,{},b)}},{"./vectortilelayer":5}],
                4: [function(a,b){function d(a,b,d,f,g){this.properties={};this.extent=d;this.type=0;this.Cc=a;this.tf=-1;this.ie=f;this.ke=g;a.mg(e,this,b)}function e(a,b,d){if(1==a)b.id=d.Ma();else if(2==a)for(a=d.Ma()+d.ga;d.ga<a;){var e=b.ie[d.Ma()],f=b.ke[d.Ma()];b.properties[e]=f}else 3==a?b.type=d.Ma():4==a&&(b.tf=d.ga)}var h=a("point-geometry");b.ma=
                ...
                b;)if(e||(e=a.Ma(),d=e&7,e>>=3),e--,1===d||2===d)f+=a.Yd(),g+=a.Yd(),f<h&&(h=f),f>x&&(x=f),g<y&&(y=g),g>z&&(z=g);else if(7!==d)throw Error("unknown command "+d);return[h,y,x,z]}},{"point-geometry":1}],
                5: [function(a,b){function d(a,b){this.version=1;this.name=null;this.extent=4096;this.length=0;this.Cc=a;this.ie=[];this.ke=[];this.he=[];a.mg(e,this,b);this.length=this.he.length}function e(a,b,d){15===a?b.version=d.Ma():1===a?b.name=d.sg():5===a?b.extent=d.Ma():2===a?b.he.push(d.ga):3===a?b.ie.push(d.sg()):
                4===a&&b.ke.push(h(d))}function h(a){for(var b=null,d=a.Ma()+a.ga;a.ga<d;)b=a.Ma()>>3,b=1===b?a.sg():2===b?a.No():3===b?a.Jo():4===b?a.Zo():5===b?a.Ma():6===b?a.Yd():7===b?a.Ho():null;return b}var l=a("./vectortilefeature.js");b.ma=d;d.prototype.feature=function(a){if(0>a||a>=this.he.length)throw Error("feature index out of bounds");this.Cc.ga=this.he[a];a=this.Cc.Ma()+this.Cc.ga;return new l(this.Cc,a,this.extent,this.ie,this.ke)}},{"./vectortilefeature.js":4}]
            }, {}, [2])(2);
        }));
        Cj = b.ma;
    }());
    ...
    var kq = [null,"http://www.opengis.net/ows/1.1"], jq = K(kq, {
    ...
    var Er = [null,"http://www.opengis.net/wms"], wr = K(Er, {
            ...
            BoundingBox: sl(function (a) {
                var b = [Im(a.getAttribute("minx")),Im(a.getAttribute("miny")),Im(a.getAttribute("maxx")),Im(a.getAttribute("maxy"))], c = [Im(a.getAttribute("resx")),Im(a.getAttribute("resy"))];
                return {
    ...
    var Wr = [null,"http://www.opengis.net/wmts/1.0"], Xr = [null,"http://www.opengis.net/ows/1.1"], Ur = K(Wr, {
    ...
    function ks(a, b, c) {
        for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f,e], m = [h,g], p = [1,0], n = {}, q = 100000, r, v, x, y, z; 0 < --q && 0 < p.length;)
    ...
    var os = new rj({ color: 'rgba(0,0,0,0.2)' }), ps = [90,45,30,20,10,5,2,1,.5,.2,.1,.05,.01,.005,.002,.001];
    ...
    k.wh = function (a) {
        ...
        f.a && (f = f.D(), h = hb(f), c = c.focus[0], c < f[0] || c > f[2]) && (c = h * Math.ceil((f[0] - c) / h), d = [d[0]+c,
        d[1],d[2]+c,d[3]]);
        c = this.v[0];
        f = this.v[1];
        h = -1;
    ...
    Vs.prototype.xc = function (a, b, c, d, e, f) {
        if ('' !== this.Fa && this.l && (this.f || this.g)) {
            ...
            this.g && (e = this.g, g = this.C, g && g.lineCap == e.lineCap && g.lineDash == e.lineDash && g.lineDashOffset == e.lineDashOffset && g.lineJoin == e.lineJoin && g.lineWidth == e.lineWidth && g.miterLimit == e.miterLimit && g.strokeStyle == e.strokeStyle || (h = [10,e.strokeStyle,e.lineWidth,
    ...
    k.gh = function (a, b) {
        var c = a[0], d = a[1], e = null, f = [NaN,NaN], g = Infinity, h = [-Infinity,-Infinity,Infinity,Infinity], l = b ? b : af;
    ...
    function Pu(a) {
        ...
        var f = Ha([f,c]), g = Hj(this.a, f), h, f = !1, l = null;
        c = null;
        if (0 < g.length) {
            this.G = e;
            g.sort(this.Ja);
    ...
    function T(a) {
        ...
        this.g(function (a) {
            ...
            c || (c = [new $k({image:new Rn({opacity:a,src:this.S})})], this.R[b] = c);
            return c;
        }.bind(this));
        this.set(vt, null);
    ...
    function iv(a, b, c, d, e, f, g, h, l, m) {
        var p = Ha([f,g,h,l]), n = a.b ? hb(p) / a.b : null, q = a.b, r = a.f.a && 0.5 < n && 1 > n, v = !1;
        if (0 < m) {
            if (a.i.f && a.l)
                var x = Ha([b,c,d,e]), v = v | 0.25 < hb(x) / a.l;
            !r && a.f.f && n && (v |= 0.25 < n);
        }
        if (v || !a.g || mb(p, a.g)) {
    ...
    kv.prototype.Zd = function () {
        var a = this.Eb.V();
        2 == a && (this.g = gv(hb(this.f) / this.c, ib(this.f) / this.c, this.j, this.Eb.resolution, 0, this.c, this.f, this.l, [{extent:this.Eb.D(),image:this.Eb.Z()}], 0));
        this.state = a;
        this.s();
    };
    ...
    k.ag = function (a, b, c) {
        ...
        if (this.j && ua(this.j, A) && this.o == l.f)
            ...
            var V = [A.ba-A.da+1,A.ja-A.fa+1], Pa = ya(Math.max(V[0] * q[0], V[1] * q[1])), V = v * Pa, ra = m.Qc(p), La = ra[0] + A.da * q[0] * v, v = ra[1] + A.fa * q[1] * v, v = [La,v,La+V,v+V];
            Ct(this, a, Pa);
    ...
    k.Ic = function (a, b, c, d) {
        ...
        var e = b / c, f = jb(a), g = kb(f, b, 0, [Math.ceil(hb(a)/e),Math.ceil(ib(a)/e)]);
    ...
    (function () {
        ...
        (function (c) {
            ...
            return function d(a, b, g) {
                ...
                1: [function(a,b,f){a=a("./processor");f.yj=a},{"./processor":2}],
                2: [function(a,b){function d(a){var b=!0;try{new ImageData(10,10)}catch(q){b=!1}return function(d){var e=d.buffers,f=d.meta,g=d.width,h=d.height,l=e.length,m=e[0].byteLength;if(d.imageOps){m=Array(l);for(d=0;d<l;++d){var n=m,p=d,q;q=new Uint8ClampedArray(e[d]);var La=g,C=h;q=b?new ImageData(q,
                ...
                this.vf,b=this.le.length,d,e;if(1===b)d=new Uint8ClampedArray(this.cd[0].buffer),e=this.cd[0].meta;else{var f=a.inputs[0].data.length;d=new Uint8ClampedArray(f);e=Array(f);for(var f=4*Math.ceil(f/4/b),g=0;g<b;++g){var h=g*f;d.set(new Uint8ClampedArray(this.cd[g].buffer),h);e[g]=this.cd[g].meta}}this.vf=null;this.cd={};a.fd(null,m(d,a.inputs[0].width,a.inputs[0].height),e);this.Ng()};b.ma=l},{"./util":3}],
                3: [function(a,b,f){var d=!0;try{new ImageData(10,10)}catch(l){d=!1}var e=document.createElement("canvas").getContext("2d");
                f.$l=function(a,b,f){if(d)return new ImageData(a,b,f);b=e.createImageData(b,f);b.data.set(a);return b}},{}]
            }, {}, [1])(1);
        }));
        Dj = b.ma;
    }());
    ...
    u(Ew, gw);
    var Hw = [new nc({html:'Map tiles by <a href="http://stamen.com/">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>.'}),vw], Gw = {
            terrain: {
                Hb: 'jpg',
                opaque: !0
            },
    ...
    t('ol.loadingstrategy.tile', function (a) {
        return function (b, c) {
            var d = a.Mc(c), e = cc(a, b, d), f = [], d = [d,0,0];
